...
import com.ktemkin.controller.ni.maschine.mk3.command.continuous.MainKnobRowModeCommand;
import com.ktemkin.controller.ni.maschine.mk3.command.continuous.TouchstripCommand;
import com.ktemkin.controller.ni.maschine.mk3.command.trigger.*;
import com.ktemkin.controller.ni.maschine.mk3.controller.MaschineControlSurface;
import com.ktemkin.controller.ni.maschine.mk3.controller.StudioEncoderModeManager;
import com.ktemkin.controller.ni.maschine.mk3.mode.*;
import com.ktemkin.controller.ni.maschine.mk3.view.*;
...
public class MaschineControllerSetup extends AbstractControllerSetup<MaschineControlSurface, MaschineConfiguration> {
    ...
    private static final List<RibbonMode> RIBBON_MODES_PITCH = List.of(RibbonMode.PITCH_DOWN, RibbonMode.PITCH_DOWN_UP, RibbonMode.PITCH_UP);
    private static final List<RibbonMode> RIBBON_MODES_CC = List.of(RibbonMode.CC_1, RibbonMode.CC_11);
    private static final List<RibbonMode> RIBBON_MODES_MASTER_VOLUME = List.of(RibbonMode.MASTER_VOLUME);
    private static final List<RibbonMode> RIBBON_MODES_NOTE_REPEAT = List.of(RibbonMode.NOTE_REPEAT_PERIOD, RibbonMode.NOTE_REPEAT_LENGTH);
